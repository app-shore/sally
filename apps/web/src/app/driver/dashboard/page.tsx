        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Progress value={(driver.current_hos.drive_remaining / 11) * 100} />
            </div>
            ...
            <div>
              ...
              <Progress value={(driver.current_hos.shift_remaining / 14) * 100} />
            </div>
            ...
            <div>
              ...
              <Progress value={(driver.current_hos.cycle_remaining / 70) * 100} />
            </div>
