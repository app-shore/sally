import { Activity, BarChart3, Building2, FileText, Flag, Home, LucideIcon, Map, MessageSquare, Package, Plus, Rocket, Settings, Truck, Users, Wallet, ClipboardList } from 'lucide-react';
