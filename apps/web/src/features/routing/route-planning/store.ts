...
import type { RoutePlan, StopInput, DriverStateInput, VehicleStateInput } from '@/features/routing/route-planning';
import type { Scenario, ScenarioListItem } from '@/shared/lib/api/scenarios-types';
import type { Load, LoadListItem } from '@/features/fleet/loads';
...
interface RoutePlanStore {
  ...
  addPlanWithSnapshot: (plan: RoutePlan) => void;
