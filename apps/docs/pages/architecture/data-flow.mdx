...
- [System Overview](/architecture) -- High-level architecture context for these flows
- [Backend Architecture](/architecture/backend) -- Detailed module structure of the services referenced here
- [Database Schema](/architecture/database) -- Table structures that these flows read and write
- [Frontend Architecture](/architecture/frontend) -- How the frontend handles the responses and events described here
