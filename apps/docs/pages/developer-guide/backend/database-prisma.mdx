...
|------|---------|----------|
| Create migration | `npm run prisma:migrate` | `apps/backend/` |
| Deploy migrations (production) | `npm run prisma:migrate:deploy` | `apps/backend/` |
| Check migration status | `npm run prisma:migrate:status` | `apps/backend/` |
| Push schema (no migration) | `npm run db:push` | `apps/backend/` |
| Generate Prisma client | `npm run prisma:generate` | `apps/backend/` |
| Open Prisma Studio | `npm run prisma:studio` | `apps/backend/` |
...
| Seed status | `npm run setup:status` | `apps/backend/` |
