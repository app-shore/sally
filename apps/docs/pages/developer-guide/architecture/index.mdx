...
description: High-level architecture of the SALLY fleet operations platform — containers, layers, and technology choices.
---
...
- [Backend Architecture](/developer-guide/architecture/backend) -- Domain-driven module design, auth flow, request lifecycle, multi-tenancy
- [Frontend Architecture](/developer-guide/architecture/frontend) -- App Router structure, feature modules, state management, theming
- [Database Schema](/developer-guide/architecture/database) -- Entity relationships, table groups, multi-tenancy pattern, HOS fields
- [Data Flow](/developer-guide/architecture/data-flow) -- Request lifecycles, alert pipelines, integration sync, real-time events
