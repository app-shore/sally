...
- [System Overview](/developer-guide/architecture) -- High-level containers and three-layer architecture
- [Frontend Architecture](/developer-guide/architecture/frontend) -- How the Next.js frontend consumes the backend API
- [Database Schema](/developer-guide/architecture/database) -- Table structure that the backend's Prisma layer queries
- [Data Flow](/developer-guide/architecture/data-flow) -- End-to-end request flows through the backend
