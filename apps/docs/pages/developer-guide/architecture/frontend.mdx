...
- [System Overview](/developer-guide/architecture) -- How the frontend fits into the overall platform
- [Backend Architecture](/developer-guide/architecture/backend) -- The API the frontend consumes
- [Data Flow](/developer-guide/architecture/data-flow) -- Request flows from frontend through backend
- [Database Schema](/developer-guide/architecture/database) -- The data model behind the API responses
