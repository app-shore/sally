...
Once you [activate a route](/getting-started/first-route#step-7-activate-the-route), SALLY's monitoring service begins tracking it across 20 alert types in 6 categories. The monitoring loop runs continuously:
...
| `SYSTEM` | Platform and integration issues | Integration failure, system error |
