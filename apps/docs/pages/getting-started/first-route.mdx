...
- **[Monitoring Active Routes](/api-reference/routes/get-monitoring)** - Track routes in real-time

### Explore API Reference

- **[POST /route-planning/optimize](/api-reference/routes#optimize-route)** - Full endpoint documentation
