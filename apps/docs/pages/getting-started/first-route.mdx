...
- **[Route Updates](/guides/route-planning/route-updates)** - Handle dynamic changes (dock delays, traffic, etc.)
- **[Rest Optimization](/guides/route-planning/rest-stops)** - How SALLY decides when and where to rest
- **[Monitoring Active Routes](/api-playground#operation/getRouteMonitoring)** - Track routes in real-time

### Explore API Reference

- **[POST /routes/plan](/api-playground#operation/planRoute)** - Full endpoint documentation
- **[Driver State Schema](/api-playground#model/DriverState)** - All HOS fields explained
- **[Segment Types](/api-playground#model/SegmentType)** - Complete segment reference

### Build Your Integration

- **[Webhooks](/guides/integration/webhook-setup)** - Get notified of route events
- **[Error Handling](/guides/integration/error-handling)** - Handle API errors gracefully
- **[Rate Limiting](/guides/integration/rate-limiting)** - Optimize API usage
...
Ready to handle alerts and monitoring? Check out our [Monitoring Guide](/guides/monitoring/overview).
