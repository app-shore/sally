...
<div className="not-prose">
  ...
  <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2">
    ...
    <div className="rounded-lg border border-border bg-card p-6">
      ...
      <div className="space-y-3">
        ...
        <Link href="/architecture" className="block text-sm text-foreground hover:underline">
          Architecture &rarr;
        </Link>
  ...
  <div className="rounded-lg border border-border bg-card px-6 py-4 text-center">
    ...
    <p className="mt-1 text-sm text-foreground">
      NestJS &middot; Next.js &middot; PostgreSQL &middot; Redis &middot; Prisma &middot; Tailwind &middot; Shadcn/ui
    </p>
  </div>
</div>
