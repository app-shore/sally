...
3. **Read the architecture overview** -- Skim the [Architecture](/architecture) section to understand the three-layer system (route planning, monitoring, dynamic updates).
