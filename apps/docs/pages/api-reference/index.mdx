...
### Routes
Create, update, and manage optimized, HOS-compliant routes with automatic rest and fuel stop insertion.

[View Routes APIs →](/api-reference/routes/plan-route)

### Alerts
Manage dispatcher alerts and notifications for proactive fleet management.

[View Alerts APIs →](/api-reference/alerts/list-alerts)

### HOS
Validate Hours of Service compliance and ensure routes meet FMCSA regulations.

[View HOS APIs →](/api-reference/hos/validate-hos)

### Optimization
Intelligent rest stop recommendations and fuel stop optimization.

[View Optimization APIs →](/api-reference/optimization/recommend-rest)

### Webhooks
Subscribe to real-time events and receive notifications when route conditions change.

[View Webhooks →](/api-reference/webhooks)
...
- [Plan Route API](/api-reference/routes/plan-route) - Start with route planning
